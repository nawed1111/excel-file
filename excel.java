...
public class excel {
    ...
    public static void compare(XSSFWorkbook wb1, XSSFWorkbook wb2, XSSFWorkbook wb3) throws Exception 
    {
        ...
        Excel.compareDataInAllSheets(loc1, loc2, loc3);
        excelCreate(wb3);
    }

    private void compareDataInAllSheets(Locator loc1, Locator loc2, Locator loc3) 
    {
    ...
    private void compareDataInSheet(Locator loc1, Locator loc2, Locator loc3){	
        ...
        {	
            ...
            if(j==0) {
            	...
            	loc3.cell.setCellValue("Current_CheckSum");
            	loc3.cell = loc3.row.createCell(Count);
            	loc3.cell.setCellValue("Prev_CheckSum");
            	...
            	flag = compareDataInRow(loc1, loc2);
    ...
    private int compareDataInRow(Locator loc1, Locator loc2) 
    {	 	
    	for (int k = 0; k < loc1.row.getPhysicalNumberOfCells(); k++){ 
    	 if (loc2.row.getPhysicalNumberOfCells()<= k) break;
           ...
           flag = compareDataInCell(loc1, loc2);
    }
    	return flag;
    }

    private int compareDataInCell(Locator loc1, Locator loc2) 
    {
        if (isCellTypeMatches(loc1, loc2)) 
        {
            ...
            switch(loc1cellType) 
            {
                ...
                case STRING:
                case ERROR:
                    	flag = isCellContentMatches(loc1,loc2);
                    	break;
                case NUMERIC:
                	    flag = isCellContentMatchesForNumeric(loc1,loc2);
                        break;
                default:
    ...
    private int isCellContentMatches(Locator loc1, Locator loc2) 
    {
    ...
    private int isCellContentMatchesForNumeric(Locator loc1, Locator loc2) 
    {
    ...
    private static void excelCreate(XSSFWorkbook wb ) throws Exception{
